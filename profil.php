...
<body id="body">
	<center>
		<input type= "button"  class="button" onClick="location.href='preporukaPrikaz.php'" value="Preporuka artikla">
		<?php print("<input type= 'button'  class='button' onClick=\"popitup('updateKorisnikForm_korisnik.php?idKorisnik=" . $idKorisnik . "')\" value='Edit profile'>"); ?>
		<br/><br/><br/>
